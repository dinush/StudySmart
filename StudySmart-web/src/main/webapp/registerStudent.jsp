                        ...
                        <div class="row">
                            <div id="main-content" class="col-md-8">
                                 ...
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li role="presentation"><a href="#">Parent</a></li>
                                ...
                                <br>
                                 <h1><span class="glyphicon glyphicon-plus" aria-hidden="true"></span><span class="label label-primary">Create a New Student Entry</span></h1>
